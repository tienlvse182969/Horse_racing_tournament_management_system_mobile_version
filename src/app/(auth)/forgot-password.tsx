...
import { MailWarning, Mail } from 'lucide-react-native';
        ...
        <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          <ScrollView
            ...
            <Animated.View entering={FadeInDown.duration(420)}>
              <AuthHeader tagline="Khôi phục quyền truy cập tài khoản" />
            </Animated.View>
              ...
              <BlurView
                ...
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.desc}>
                    Nhập email tài khoản, hệ thống sẽ gửi link tạo mật khẩu mới. Link có hiệu lực trong thời gian giới hạn.
                  </Text>
                  <TextInput
                    label="Email"
                    value={email}
                  ...
                  <Animated.View entering={FadeIn.delay(140).duration(380)}>
                    <TouchableOpacity style={styles.primaryBtn} onPress={submit} disabled={loading} activeOpacity={0.85}>
                      {loading
                        ...
                        : <Text style={styles.primaryText}>Gửi link đặt lại</Text>}
                    </TouchableOpacity>
                  </Animated.View>
